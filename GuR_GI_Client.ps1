...
function checkForUpdates($Silent) {
	...
	Write-Host "Script auf Updates prùfen"
...
function GuRGIMenue
{
    ...
    Write-Host "Bitte Punkt 99 ausfùhren!" -ForegroundColor Red
    }
	...
	Write-Host
	Write-Host "7: Grund-Setup (1-3 automatisch durchfùhren"
	Write-Host	
    Write-Host	
	Write-Host "96: Versionshistorie"
	Write-Host 
	Write-Host "97: Script auf Updates prùfen"
	Write-Host
...
#	Set-Location -Path $PSScriptRoot\filedepot\
   ...
   '7' {
    Write-Host "Grund-Setup (1-3 automatisch durchf¸hren)"
    stdInstall "1"
    toolsCopy "1"
    regKeys "1"
   }
